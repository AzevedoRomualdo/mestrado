    ...
    <v-stepper v-model="e1" style="margin-left:50px; margin-top:30px; margin-right:50px">
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="3">
          <v-layout row wrap style="margin-left:6vh; ">
            <span style="color:black; font-size:36px; ">Escolher Formulário de Avaliação</span>
          </v-layout>
          ...
          <v-layout row wrap style="margin-left: 77vh; margin-top: 7vh;">
            <v-flex xs3 sm3>
              <v-select
                ...
                label="formulario"
                v-model="atividade.id_formulario"
                outlined
              ></v-select>
            </v-flex>
            <!-- <v-flex xs3 sm3>
        ...
        <v-stepper-content step="4">
            ...
            <v-flex xs3 sm4>
              ...
              <v-flex xs3 sm3>
                <input
                  ...
                  style="margin-left:16vh; border: 2px solid DimGray; border-radius: 5px;  height: 59px; width: 147vh;"
                  type="text"
                  class="form-control"
                />
              </v-flex>
          ...
          <v-layout>
            <v-flex xs3 sm3>
              <label for="ge-text-input">
                <span style="font-size: 20px;">Data inicio:</span>
              </label>

              <v-flex xs3 sm3>
                <input
                  v-model="atividade.dtinicio"
                  style="margin-left:16vh; border: 2px solid DimGray; border-radius: 5px;  height: 39px; width: 27vh;"
                  type="date"
                  class="form-control"
                />
              </v-flex>
            ...
            <v-flex xs3 sm3>
              <label for="ge-text-input">
                <span style="font-size: 20px;">Data fim:</span>
              </label>

              <v-flex xs3 sm3>
                <input
                  v-model="atividade.dtfim"
                  style="margin-left:16vh; border: 2px solid DimGray; border-radius: 5px;  height: 39px; width: 27vh;"
                  type="date"
                  class="form-control"
                />
            ...
            <v-flex xs12>
              <input
                type="file"
                id="exemplo"
                title="Selecione um arquivo de apoio para as informações sobre a atividade"
                @change="uploadFile"
                ref="files"
              />
            </v-flex>
...
export default {
  ...
  methods: {
      ...
      if (this.$route.params.id) {
        ...
        axios
          ...
          .then(response => {
            ...
            this.atividade.id_formulario = response.data[0].id_formulario;
          })
          .catch(e => {});
      }
    },
    carregaFormulario: function() {
      axios
        .get("/listaformulario/" + this.usuario[0].id)
        .then(response => {
    ...
    cadastrar: function() {
      this.atividade.exemplo = exemplo;
        ...
        axios
          ...
          .then(response => {
            if (response.data !== false) {
              ...
              this.snackbar = true;
              this.nomeCampo = "";
              this.textoAlerta = "Atividade cadastrada com sucesso";
              this.$router.push({ name: "listasolicitacao" });
            } else {
              this.cor = "red";
              this.snackbar = true;
              this.nomeCampo = "";
              this.textoAlerta = "Essa Atividade já existe";
              return;
            }
          })
