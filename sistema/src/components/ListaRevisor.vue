        ...
        <div class="box box-default color-palette-box">
          ...
          >
            ...
            <v-flex xs12 sm2 style=" margin-left:-220px; margin-top:3vh">
              <v-radio-group v-model="item.resp" row>
...
export default {
  ...
  methods: {
    edit() {
      ...
      axios
        .put("/editcoment/" + this.tabrev, this.geraldine)
        .then(response => {});
      ...
      axios.put("/editresposta", this.aspresp).then(response => {
        if (response.data != false) {
          ...
          this.snackbar = true;
          this.nomeCampo = "";
          this.textoAlerta = "Revisão Alterada";
    ...
    ratividade() {
      ...
      axios.post("/addresposta", this.aspresp).then(response => {
        if (response.data != false) {
          ...
          this.snackbar = true;
          this.nomeCampo = "";
          this.textoAlerta = "Atividade Revisada";
          // this.$router.push({ name: "------0------" });
        } else {
          this.cor = "red";
          this.snackbar = true;
    ...
    listaSolicitacao: function() {
      ...
      //console.log(idusuario);
      axios
        .get("/revisao/" + this.id + "/" + idusuario)
        .then(response => {
          this.itens = response.data;
          this.tabrev = response.data[0].id_tabrevisores;

          axios
            .get("/visualizaratividade/" + response.data[0].id_atividade)
            .then(response => {
              ...
              axios
                ...
                .then(response => {
                  ...
                  axios
                    .get(
                      "/retresp/" + idusuario + "/" + this.dadosAtividade.id_atv
                    )
                    .then(response => {
