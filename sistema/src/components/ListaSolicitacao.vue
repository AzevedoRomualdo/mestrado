<template>
  <section class="container-fluid-12" data-app>
        ...
        <div class="box box-default color-palette-box">
          <v-layout row wrap style="margin-top:5vh">
            ...
            <v-tooltip bottom>
              ...
              <span v-if="usuario[0].tipo == 1">
                Nesta tela, você pode manipular as atividades cadastradas. Aqui
                é possível visualizar, editar e excluir as atividades. Além de
                poder escolher os revisores ou verificar se o sorteio dos mesmos
          ...
          >
            <template slot="items" slot-scope="props">
              ...
              <td v-if="usuario[0].tipo == 1">
                <v-icon
                  title="Sortear revisores"
                  style="color:black; "
                  class="mr-2"
                  @click="sorteio(props.item)"
                  >group</v-icon
                >
                <v-icon
              ...
              <td v-else>
                <v-icon style="color:black;" class="mr-2"
...
export default {
  ...
  methods: {
    ...
    sorteio(item) {
      //alert(JSON.stringify(item));
      console.log(item);
      let url = "/sorteiorevisor/" + item.id_atv;
      this.$router.push(url);
    },
    editItem(item) {
      //alert(JSON.stringify(item));
