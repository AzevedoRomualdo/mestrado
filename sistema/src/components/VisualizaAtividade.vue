...
<v-card style="margin-left:26px; margin-right:26px" >
  ...
  <v-layout row wrap style="margin-top:8vh;">
   <v-flex xs2 sm4 style="margin-left:28px">
    ...
    <v-flex xs12 sm3 style = "margin-left: 176px">
      <label style = "font-size: 18px; font-weight: bold">Nº Revisores:</label>
        <span style="font-size: 16px;">{{dadosAtividade.nrevisores}}</span>
        <!-- <v-text-field
        readonly
        label = "Nº Revisores"
        v-model="dadosAtividade.nrevisores"
         style="width: 45vh;">
        </v-text-field> -->
    </v-flex>
     <v-flex xs12 sm3>
       <label style = "font-size: 18px; font-weight: bold">Nº Rodadas:</label>
        <span style="font-size: 16px;">{{dadosAtividade.nrodadas}}</span>
        <!-- <v-text-field
        readonly
        label = "Nº Rodadas"
        v-model="dadosAtividade.nrodadas"
         style="width: 45vh;">
        </v-text-field> -->
    </v-flex>
</v-layout>
...
<v-layout row wrap style="margin-left:2vh; margin-top:5vh">
  ...
  <v-layout v-for="item in listaaspectos" :key="item.id_aspectos" row wrap style="margin-left:9vh; margin-top:3vh">
    
      <v-flex xs12 sm2>
        <v-text-field
        readonly
        label = "Id"
         v-model="item.id_aspectos"
         style="width: 16vh;">
        </v-text-field>
    </v-flex>
      <v-flex xs12 sm6>
